...
export const metadata = createPageMetadata({
  title: "O nas",
  description:
    "Poznaj HeadCraft — polską markę kolekcjonerskich główek Minecraft. Rzemiosło, jakość i pasja do gier.",
  path: "/o-nas",
});

const processSteps = [
  { step: "01", title: "Modelowanie", desc: "Digitalizacja skina w wysokiej rozdzielczości" },
  { step: "02", title: "Produkcja", desc: "Druk 3D z żywicy premium" },
  { step: "03", title: "Wykończenie", desc: "Ręczna obróbka i lakierowanie" },
    ...
    <div className="container-site section-padding">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <p className="mt-6 text-lg text-muted-foreground text-pretty">
          HeadCraft powstał z prostej idei: Twój skin to Twoja historia w grze.
          Zasługuje na miejsce na półce — nie tylko na ekranie.
        </p>
      </div>
      ...
      <section className="mt-20">
        ...
        <p className="mt-4 max-w-3xl text-muted-foreground">
          Tworzymy fizyczne główki Minecraft najwyższej jakości — produkowane w
          Polsce, zaprojektowane dla kolekcjonerów, graczy i twórców. Nie
          dropshipping. Nie masówka. Rzemiosło.
        </p>
      </section>
