...
export const metadata = createPageMetadata({
  title: "Regulamin",
  description: "Regulamin sklepu HeadCraft — warunki zakupu kolekcjonerskich główek Minecraft.",
  path: "/regulamin",
});
  ...
  return (
    <div className="container-site section-padding">
      <div className="prose prose-invert mx-auto max-w-3xl">
        ...
        <p>
          Czas realizacji: 3–5 dni roboczych. Dostawa kurierem lub do paczkomatu
