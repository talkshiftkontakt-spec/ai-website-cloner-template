...
export const metadata = createPageMetadata({
  ...
  description:
    "Zobacz jak kolekcjonerzy HeadCraft eksponują główki Minecraft na półkach, biurkach i w setupach streamingowych.",
  path: "/inspiracje",
});
  ...
  return (
    <div className="container-site section-padding">
      ...
      <p className="mt-4 max-w-2xl text-muted-foreground">
        Zobacz jak kolekcjonerzy HeadCraft prezentują swoje główki — od
